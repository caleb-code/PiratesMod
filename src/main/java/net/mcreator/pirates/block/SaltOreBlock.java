...
import net.mcreator.pirates.item.SaltGemItem;
...
public class SaltOreBlock extends PiratesElements.ModElement {
	@ObjectHolder("pirates:saltore")
	public static final Block block = null;
	public SaltOreBlock(PiratesElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SaltGemItem.block, (int) (2)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("saltore", "saltore", blockAt -> {
